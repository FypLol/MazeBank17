...
{
    partial class DepositoContenido
    {
        /// <summary>
        ...
        {
            groupBoxDeposito = new GroupBox();
            gboxBtonesCajero = new GroupBox();
            btnEnterDepositar = new Button();
            ...
            rtboxCantidadDepositar = new RichTextBox();
            lbl_TituloDepositar = new Label();
            groupBoxDeposito.SuspendLayout();
            gboxBtonesCajero.SuspendLayout();
            SuspendLayout();
            // 
            // groupBoxDeposito
            // 
            groupBoxDeposito.AccessibleRole = AccessibleRole.MenuBar;
            groupBoxDeposito.BackColor = Color.White;
            groupBoxDeposito.Controls.Add(gboxBtonesCajero);
            groupBoxDeposito.Controls.Add(rtboxCantidadDepositar);
            groupBoxDeposito.Controls.Add(lbl_TituloDepositar);
            groupBoxDeposito.Location = new Point(3, -2);
            groupBoxDeposito.Name = "groupBoxDeposito";
            groupBoxDeposito.Size = new Size(686, 551);
            groupBoxDeposito.TabIndex = 2;
            groupBoxDeposito.TabStop = false;
            // 
            // gboxBtonesCajero
            // 
            gboxBtonesCajero.Controls.Add(btnEnterDepositar);
            ...
            gboxBtonesCajero.TabIndex = 22;
            gboxBtonesCajero.TabStop = false;
            // 
            // btnEnterDepositar
            // 
            btnEnterDepositar.BackColor = Color.Green;
            btnEnterDepositar.FlatAppearance.BorderSize = 0;
            btnEnterDepositar.FlatStyle = FlatStyle.Flat;
            btnEnterDepositar.Location = new Point(13, 219);
            btnEnterDepositar.Name = "btnEnterDepositar";
            btnEnterDepositar.Size = new Size(70, 61);
            btnEnterDepositar.TabIndex = 24;
            btnEnterDepositar.Text = "ENTER";
            btnEnterDepositar.UseVisualStyleBackColor = false;
            btnEnterDepositar.Click += btnEnterDepositar_Click;
            // 
            // btnBorrarNumero
            // 
            ...
            // 
            // rtboxCantidadDepositar
            // 
            rtboxCantidadDepositar.BackColor = SystemColors.ScrollBar;
            rtboxCantidadDepositar.BorderStyle = BorderStyle.None;
            rtboxCantidadDepositar.Font = new Font("Segoe UI", 72F, FontStyle.Regular, GraphicsUnit.Point, 0);
            rtboxCantidadDepositar.Location = new Point(192, 90);
            rtboxCantidadDepositar.Name = "rtboxCantidadDepositar";
            rtboxCantidadDepositar.ScrollBars = RichTextBoxScrollBars.None;
            rtboxCantidadDepositar.Size = new Size(317, 111);
            rtboxCantidadDepositar.TabIndex = 12;
            rtboxCantidadDepositar.Text = "";
            // 
            // lbl_TituloDepositar
            // 
            lbl_TituloDepositar.AutoSize = true;
            lbl_TituloDepositar.Font = new Font("SF Pro Display", 15.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            lbl_TituloDepositar.Location = new Point(162, 50);
            lbl_TituloDepositar.Name = "lbl_TituloDepositar";
            lbl_TituloDepositar.Size = new Size(390, 25);
            lbl_TituloDepositar.TabIndex = 0;
            lbl_TituloDepositar.Text = "Ingrese la cantidad que desea depositar";
            // 
            // DepositoContenido
            // 
            ...
            Controls.Add(groupBoxDeposito);
            FormBorderStyle = FormBorderStyle.None;
            MinimumSize = new Size(692, 561);
            Name = "DepositoContenido";
            Text = "DepositoContenido";
            groupBoxDeposito.ResumeLayout(false);
            groupBoxDeposito.PerformLayout();
        ...
        private GroupBox groupBoxDeposito;
        private Label lbl_TituloDepositar;
        private RichTextBox rtboxCantidadDepositar;
        private GroupBox gboxBtonesCajero;
        private Button btnEnterDepositar;
